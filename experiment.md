...
*   **Status**: 🟢 **IN PROGRESS** (Active on Map 1)
*   **Start Date**: January 29, 2026
*   **Total Target Maps**: 23
*   **Steps per Map**: 2,050,000 (`t_max`)
*   **Overall Completion**: 1/23 maps started (~60% of first map done)
...
| Map ID | Map Name | Status | Current Step | Performance (Win Rate) | Console Log (Clickable) | Sacred Result (Clickable) |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| 1 | 10m_vs_11m | Running | ~1,230,000 | **84.6%** | [Log](../sird_run_10m_vs_11m.log) | [Sacred ID 24](../SIDM/SIRD/results/sacred/24/) |
| 2 | 1c3s5z | Pending | 0 | - | [Log](../sird_run_1c3s5z.log) | [Sacred Result](../SIDM/SIRD/results/sacred/) |
| 3 | 25m | Pending | 0 | - | [Log](../sird_run_25m.log) | [Sacred Result](../SIDM/SIRD/results/sacred/) |
| 4 | 27m_vs_30m | Pending | 0 | - | [Log](../sird_run_27m_vs_30m.log) | [Sacred Result](../SIDM/SIRD/results/sacred/) |
| 5 | 2c_vs_64zg | Pending | 0 | - | [Log](../sird_run_2c_vs_64zg.log) | [Sacred Result](../SIDM/SIRD/results/sacred/) |
| 6 | 2m_vs_1z | Pending | 0 | - | [Log](../sird_run_2m_vs_1z.log) | [Sacred Result](../SIDM/SIRD/results/sacred/) |
